...
## <span aria-hidden="true">🧱✈️🌦️</span> Build a daily panel: flights × weather
...
## <span aria-hidden="true">🔍✈️🌧️</span> First look: does delay rise with yesterday’s rain?
...
## <span aria-hidden="true">🌤️🔄🌧️</span> Today vs. yesterday: contrasting weather states
...
## <span aria-hidden="true">⚙️🌦️🔍</span> Modeling: does yesterday’s weather matter after controls?
...
## <span aria-hidden="true">🔗🌧️✈️</span> Cancellation link: does yesterday’s rain raise today’s cancels?
...
## <span aria-hidden="true">🔮🌧️🧪</span> What-if: set yesterday’s rain to zero
...
## <span aria-hidden="true">📚✍️</span> References & Credits
