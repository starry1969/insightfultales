...
description: "Bad weather can disrupt schedules, but does the pain linger after skies clear? This short data story explores whether today's flight delays still carry the fingerprint of yesterday's weather — a simple form of system memory."
keywords: ["weather memory", "flight delays", "weather and delays", "lagged weather effects", "delay propagation", "aviation weather impacts", "NYC flights", "nycflights13", "temporal dependence", "system memory", "weather persistence", "airline performance", "daily weather effects"]
categories: ["climate", "systems", "data-science"]
---
<section class="hero">
  <h1><span aria-hidden="true">☀️</span> Weather Memory</h1>
  <h2 class="hero-subtitle">Do flight delays 'remember' yesterday's weather? Evidence from nycflights13.</h2>
  <p class="hero-text">
...
## <span aria-hidden="true">🎯</span> Goal & approach
...
## <span aria-hidden="true">🧱</span> Build a daily panel: flights × weather
...
## <span aria-hidden="true">🔍️</span> First look: does delay rise with yesterday’s rain?
...
## <span aria-hidden="true">🌤️️</span> Today vs. yesterday: contrasting weather states
...
## <span aria-hidden="true">⚙️</span> Modeling: does yesterday’s weather matter after controls?
...
tidy_coefs <- broom::tidy(model_full, conf.int = TRUE) %>%
  ...
  mutate(term = recode(term,
    ...
    temp_F_lag1    = "Yesterday temperature (°F)"
  ))
...
## <span aria-hidden="true">✈️</span> Airport where memory is strongest
...
## <span aria-hidden="true">🔗️</span> Cancellation link: does yesterday’s rain raise today’s cancels?
...
## <span aria-hidden="true">🔮</span> What-if: set yesterday’s rain to zero
...
## <span aria-hidden="true">🔄</span>Bonus: Today vs. Yesterday on a joint scatter (hoverable)
...
## <span aria-hidden="true">🎵</span> Story beats
...
## <span aria-hidden="true">⚙️</span> Practical implications
...
<section class="dataset-source">
  ...
  <span><strong>Dataset:</strong> 
    <a href="../datasets/nycflights13-the-dataset-that-took-off.html">nycflights13</a>
  </span>
</section>
...
## <span aria-hidden="true">🕊️</span> Gentle call to curiosity
