...
favicon: images/butterfly-icon.png
format:
  html:
    toc: true
    toc-depth: 3
...
## <span aria-hidden="true">📊</span> Data & Definitions — *Why these choices?*
...
## <span aria-hidden="true">🌊📈😣</span> Scatter in the first wave predicts afternoon pain
...
## <span aria-hidden="true">✈️🔁🌊</span> Short-haul routes amplify the ripple
...
## <span aria-hidden="true">🌦️📈</span> After weather controls, the association persists
...
## <span aria-hidden="true">💭</span> A tiny “what-if” simulation
...
## <span aria-hidden="true">🧰</span> Practical Applications
...
## <span aria-hidden="true">🚧</span> Limitations (what we didn’t model)
...
## <span aria-hidden="true">📋</span> Summary (what we discovered)
