...
<h1><span aria-hidden="true">🦋</span> Butterfly Morning Delays</h1>

<h2 class="hero-subtitle">

How early-morning schedule noise ripples through the rest of the day.

</h2>

<p class="hero-text">

A story about cause and consequence in motion — how a stormy sunrise or a missed departure can reshape an entire day of air travel.
...
<img src="../images/dataset-icons/nycflights13.svg" class="dataset-icon-small" aria-hidden="true"/> <strong>Dataset:</strong> <a href="../datasets/nycflights13-the-dataset-that-took-off.html">nycflights13</a>
