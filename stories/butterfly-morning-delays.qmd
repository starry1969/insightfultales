...
## Data & Definitions — *Why these choices?*
...
## Finding 1 — Scatter in the first wave predicts afternoon pain
...
## Finding 2 — Short-haul routes amplify the ripple
...
## Finding 3 — After weather controls, the association persists
...
## Finding 4 — A tiny “what-if” simulation
...
## Limitations (what we didn’t model)
